...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //create button for showing currently played cards
        Button currentplayersCardsButton = (Button) findViewById(R.id.currentplayersCardsButton);
        //create the onClick listen to gather information and put into a bundle
        //next start the popUp window activity and pass information for each player to that activity
        ...
        playedCardsButton.setOnClickListener(new View.OnClickListener() {
                ...
                currentplayersCardsButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Bundle currentplayersCardsButtonBundle = new Bundle();
                        //bundle players previously played cards as strings,
                        currentplayersCardsButtonBundle.putString("stringCurrentPlayer", playerOrder[turnOrder].getCurrentCards());
                        currentplayersCardsButtonBundle.putString("stringPlayer2", playerOrder[turnOrder2].getCurrentCards());
                        currentplayersCardsButtonBundle.putString("stringPlayer3", playerOrder[turnOrder3].getCurrentCards());
                        currentplayersCardsButtonBundle.putString("stringPlayer4", playerOrder[turnOrder4].getCurrentCards());
                        //bundle players names as strings
                        currentplayersCardsButtonBundle.putString("nameCurrentPlayer", playerOrder[turnOrder].getPlayerName());
                        currentplayersCardsButtonBundle.putString("namePlayer2", playerOrder[turnOrder2].getPlayerName());
                        currentplayersCardsButtonBundle.putString("namePlayer3", playerOrder[turnOrder3].getPlayerName());
                        currentplayersCardsButtonBundle.putString("namePlayer4", playerOrder[turnOrder4].getPlayerName());

                        Intent currentplayersCardsIntent = new Intent(MainActivity.this, CurrentPlayersCards.class);
                        currentplayersCardsIntent.putExtras(currentplayersCardsButtonBundle);
                        startActivity(currentplayersCardsIntent);
            ...
            private void beginRound() {
               ...
               /* //creating the button to see the cards initially set for the begiinning of the round to each player
                Button startingcards = (Button) findViewById(R.id.startingcards);

                startingcards.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent cardIntent = new Intent(MainActivity.this, CurrentPlayersCards.class);
                    ...
                    button1.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (cardChoice == 1) {
                                ...
                                //add the players current card to the array of current cards in the Player class
                                playerOrder[turnOrder].setCurrentCards(playerOrder[turnOrder].getCard1());
                                ...
                                playerOrder[turnOrder].setCurrentCards(playerOrder[turnOrder].getCard2());
                                Intent intent = new Intent(MainActivity.this, GuardLayout.class);
                                startActivity(intent);
                            }
                    ...
                    button1.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (cardChoice == 1) {
                                ...
                                Bundle priestBundle = new Bundle();
                                //bundle chosen player's current cards as strings

                                priestBundle.putString("stringCurrentPlayer", playerOrder[turnOrder].getCurrentCards());
                                //bundle chosen player name as strings
                                priestBundle.putString("nameCurrentPlayer", playerOrder[turnOrder].getPlayerName());


                                Intent priestIntent = new Intent(MainActivity.this, PriestLayout.class);
                                priestIntent.putExtras(priestBundle);
                                startActivity(priestIntent);
