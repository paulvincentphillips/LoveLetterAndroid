...
public class MainActivity extends AppCompatActivity {
    ...
    /*
        ...
        onCreate needs to start and finish, needs to return a 'I'm finished creating the stuff' message to android so we don't look around in here.
    ...
    private void beginTurn()
    {
        ...
        final ImageButton ib = (ImageButton) findViewById(R.id.card1);
        final ImageButton ib2 = (ImageButton) findViewById(R.id.card2);
